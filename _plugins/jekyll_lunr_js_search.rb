  ...
  module LunrJsSearch
    class SearchEntry
      ...
      def self.create_from_page(page, renderer)
        ...
        # We'll do without body as this is a code search
        body = nil # renderer.render(page)
        date = nil
        categories = page.to_liquid['ns'] || []
      ...
      def initialize(title, url, date, categories, body)
        @title, @url, @date, @categories, @body = title, url, date, categories, nil
      end
